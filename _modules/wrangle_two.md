...
> `ifelse()` statements change be nested.)
...
> #### Quick exercise
>
> In a single set of chained functions (no assignment), select 3-5
> variables, filter based on two conditions, and arrange based on one of
> the variables.
